...
using _Project.Code.Characters.Behaviour.Decisions.Enemy._Base;
using EnemyAI;
using UnityEngine;
using UnityEngine.AI;

namespace _Project.Code.Characters.Behaviour.Controllers
{
    public class EnemyStateController : CharacterStateController
    {
		...
		public CharacterState remainState;
		[Space(10)]
		...
		public void TransitionToState(CharacterState nextState, EnemyCharacterDecision decision)
		{
